...
import kontroler.Clan.KKIFRMUnosClana;
...
public class FrmUnosClana extends javax.swing.JPanel {
    ...
    public FrmUnosClana() {
        initComponents();
        KKIFRMUnosClana.inicijalizujKomboBoks(jcbOrganizacija, jcbGrad, jcbZivotinja);
    }
    ...
    private void jbtSacuvajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtSacuvajActionPerformed
        KKIFRMUnosClana.sacuvajClana(jtfJmbg, jpLjubimac, jdcDatumRodjenja, jdcDatumUclanjenja, jtfIme, jtfPrezime, jcbOrganizacija, jcbGrad, jdcDatumSpasavanjaLjubimca);
    ...
    private void jbtDodajLjubimcaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtDodajLjubimcaActionPerformed
        KKIFRMUnosClana.dodajLjubimca(jdcDatumSpasavanjaLjubimca, jtfImeLjubimca, jpLjubimac, jcbZivotinja);
